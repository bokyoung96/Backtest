...
class MethodologyPayoutttmlfq0(Methodology):
    def __init__(self,
                 mkt: str = 'KOSPI200',
    ...
    def get_raw_factor(self):
        try:
            Tools.validation_df_size(self.data['dividends_ttm_lfq0'],
                                     self.data['ni_ttm_lfq0'])
            return self.data['dividends_ttm_lfq0'] / self.data['ni_ttm_lfq0']
