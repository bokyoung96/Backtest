...
from bt.methodologies.methodology_momentum import MethodologyMomentum
from bt.methodologies.methodology_price_trends import MethodologyPriceTrends


class MethodologyMPTCherrypick(Methodology):
    def __init__(self,
                 mkt: str = 'KOSPI200',
        ...
        top_pct = kwargs.pop('top_pct', 0.05)
    ...
    def get_momentum_methodology(self) -> MethodologyMomentum:
        if self._momentum_methodology is None:
            self._momentum_methodology = MethodologyMomentum(
                mkt=self.mkt,
...
if __name__ == "__main__":
    m = MethodologyMPTCherrypick(mkt='KOSPI200',
                                 start_date='20110101',
                                 end_date='20250627',
                                 freq='monthly',
                                 quantile=5,
